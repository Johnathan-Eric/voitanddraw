...
if ($op == 'post') {
	...
	if (checksubmit()) {
		...
		itoast('编辑成功', $this->createWebUrl('shop_article', array('op' => 'display', 'storeid' => $storeid)), 'success');
	}
}
