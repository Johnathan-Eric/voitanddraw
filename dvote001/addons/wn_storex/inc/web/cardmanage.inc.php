...
if ($op == 'display') {
	$actions_permit = check_user_permit(array('wn_storex_permission_mc_credit1', 'wn_storex_permission_mc_credit2'));
...
if ($op == 'modal') {
	...
	include $this->template('extend/cardmodel');
	exit();
}
...
include $this->template('extend/cardmanage');