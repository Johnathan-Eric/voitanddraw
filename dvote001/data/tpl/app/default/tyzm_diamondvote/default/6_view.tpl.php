...
<div class="succeed" id="succeed" style="display:none"onclick="hidemod('succeed');">
   ...
   <?php  } else { ?>
   <div class="voteadd" onclick="location='<?php  echo $reply['voteadurl'];?>'"><img src="<?php  echo tomedia($reply['voteadimg']);?>"  class="adimg" width="100%"  /><p class="adtext"><?php  echo $reply['voteadtext'];?></p></div>
   <?php  } ?>
