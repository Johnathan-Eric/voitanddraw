...
load()->func('az');
	...
	$updatehost = 'http://zxazsq.qincewang.com/update.php';
	...
	$updatenowinfo = file_get_contents($updatehosturl);
		...
		itoast('您还不是亲测网金币会员或获取授权失败，请联系QQ1926337827处理！', url('module/manage-system/not_installed', array('account_type' => '1')), 'error');
	}
