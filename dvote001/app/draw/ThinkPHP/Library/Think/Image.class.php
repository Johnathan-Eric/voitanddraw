...
class Image{
     ...
     * @param  bool $imgalpha  是否保存通透PNG图
     * @return Object          当前图片处理库对象
     */
    public function water($source, $locate = self::IMAGE_WATER_SOUTHEAST,$alpha=80, $imgalpha = false){
        $this->img->water($source, $locate, $alpha, $imgalpha);
        return $this;
    }
