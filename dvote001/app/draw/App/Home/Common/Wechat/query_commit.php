...
class QueryCommit extends  Common_util_pub{
    public  function __construct($appid=null){
        $authoid= new \AuthorizerAccessToken();
        $this->url="https://api.weixin.qq.com/wxa/get_latest_auditstatus?access_token=".$authoid->getInfo();
    }
    public function getQuerycommit(){
