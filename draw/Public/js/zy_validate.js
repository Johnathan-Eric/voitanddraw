...
var isen_num= function(value) {
			return /^\w+$/.test(value);
		}
var isip4= function(value) {
...
var isqq= function(value) {
			return /^\d{5,}$/.test(value);
		}
var ischinese= function(value) {
			return /^[\u4e00-\u9fa5]+$/.test(value);
		}
var iscn_username= function(value) {
...
var istelphone= function(value) {
			return /^0\d{2,3}(\-)?\d{7,8}$/.test(value) || /^1[3|4|5|8][0-9]\d{8}$/.test(value);
		}
